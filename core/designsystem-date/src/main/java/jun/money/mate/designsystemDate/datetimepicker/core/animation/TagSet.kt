package jun.money.mate.designsystemDate.datetimepicker.core.animation
    ...
    return when (name) {
        ...
        "accelerateInterpolator" ->
            attrs.attrs(
                res,
                theme,
                AndroidVectorResources.STYLEABLE_ACCELERATE_INTERPOLATOR,
            ) { a ->
        ...
        "decelerateInterpolator" ->
            attrs.attrs(
                res,
                theme,
                AndroidVectorResources.STYLEABLE_DECELERATE_INTERPOLATOR,
            ) { a ->
                val factor = a.getFloat(
        ...
        "cycleInterpolator" ->
            attrs.attrs(
                res,
                theme,
                AndroidVectorResources.STYLEABLE_CYCLE_INTERPOLATOR,
            ) { a ->
                CycleEasing(
                    a.getFloat(
                        AndroidVectorResources.STYLEABLE_CYCLE_INTERPOLATOR_CYCLES,
                        1.0f,
                    ),
                )
            }
        ...
        "overshootInterpolator" ->
            attrs.attrs(
                res,
                theme,
                AndroidVectorResources.STYLEABLE_OVERSHOOT_INTERPOLATOR,
            ) { a ->
                OvershootEasing(
                    a.getFloat(
        ...
        "pathInterpolator" ->
            attrs.attrs(
                res,
                theme,
                AndroidVectorResources.STYLEABLE_PATH_INTERPOLATOR,
            ) { a ->
                val pathData =
